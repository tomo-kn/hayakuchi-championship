...
Sentence.seed do |s|
  ...
  s.contentHiragana = "あかかぴばらあおかぴばらきかぴばら"
  s.contentMisconversion = "赤カピバラ 青カピバラ 黄カピバラ"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "しょうじょしゃんそんかしゅしんしゅんしゃんそんしょー"
  s.contentMisconversion = "少女シャンソン歌手新春シャンソンショー"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "このくいのくぎはひきぬきにくいくぎだ"
  s.contentMisconversion = "この杭のクギは引き抜きにくいクギだ"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "まさちゅーせっつしゅうでまじゅつししゅぎょうちゅう"
  s.contentMisconversion = "マサチューセッツ州で魔術師修行中"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "ほんじょうぞうしょうゆこうそくぞうしょくちゅう"
  s.contentMisconversion = "本醸造醤油 高速増殖中"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "かたかたかったからかったかたたたききかたたたきにくかった"
  s.contentMisconversion = "肩固かったから買った肩叩き機 肩叩きにくかった"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "たけがきにたけたてかけたかったからたけたてかけた"
  s.contentMisconversion = "竹垣に竹立てかけたかったから竹立てかけた"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "させつしゃせんようしゃせんうせつしゃがぎゃくそう"
  s.contentMisconversion = "左折者専用車線 右折者が逆走"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "しょうしゃのしゃちょうがちょうさしょそうさちゅう"
  s.contentMisconversion = "商社の社長が 調査書操作中"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "とうきょうとっきょきょかきょくきょかきょくちょうのきょか"
  s.contentMisconversion = "東京特許許可局 許可局長の許可"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "ぶすばすがいどばすがすばくはつ"
  s.contentMisconversion = "ブスバスガイド バスガス爆発"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "よぼよぼびょうよぼうびょういんよぼうびょうしつ"
  s.contentMisconversion = "よぼよぼ秒予防病院予防病室"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "れもんとめろんをれみおろめんるみおんでしょくす"
  s.contentMisconversion = "レモンとメロンをレミオロメン ルミオンで食す"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "わらわばわらえわらわはわらわれるいわれはない"
  s.contentMisconversion = "笑わば笑え 笑わは笑われる謂れはない"
end
...
Sentence.seed do |s|
  ...
  s.contentHiragana = "きょうのなまだらならなままながつお"
  s.contentMisconversion = "きょうのなまだらならなままながつお"
end
